...
extension UniversalServer where APIHandler: APIProtocol {
    ...
    fileprivate func listSystemVariable(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                ...
                let headers: Operations.listSystemVariable.Input.Headers =
                    .init(
    ...
    fileprivate func createSystemVariable(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.createSystemVariable.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func bulkDeleteSystemVariable(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.bulkDeleteSystemVariable.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func getSystemVariable(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.getSystemVariable.Input.Path = .init(
                    key: try converter.getPathParameterAsURI(
                        in: metadata.pathParameters,
                        name: "key",
                        as: Components.Parameters.SystemVariableKey.self
                    )
                )
                let headers: Operations.getSystemVariable.Input.Headers = .init(
                    accept: try converter.extractAcceptHeaderIfPresent(
                        in: request.headerFields
                    )
                )
    ...
    fileprivate func patchSystemVariable(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.patchSystemVariable.Input.Path = .init(
                    key: try converter.getPathParameterAsURI(
                        in: metadata.pathParameters,
                        name: "key",
                        as: Components.Parameters.SystemVariableKey.self
                ...
                let headers: Operations.patchSystemVariable.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func updateSystemVariable(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.updateSystemVariable.Input.Path = .init(
                    key: try converter.getPathParameterAsURI(
                        in: metadata.pathParameters,
                        name: "key",
                        as: Components.Parameters.SystemVariableKey.self
                ...
                let headers: Operations.updateSystemVariable.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func listSystemPermission(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                ...
                let headers: Operations.listSystemPermission.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func createSystemPermission(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.createSystemPermission.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func bulkDeleteSystemPermission(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers:
                    Operations.bulkDeleteSystemPermission.Input.Headers = .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
                    )
    ...
    fileprivate func detailSystemPermission(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.detailSystemPermission.Input.Path = .init(
                    permissionKey: try converter.getPathParameterAsURI(
                        in: metadata.pathParameters,
                        name: "permissionKey",
                        as: Components.Parameters.SystemPermissionKey.self
                    )
                )
                let headers: Operations.detailSystemPermission.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func patchSystemPermission(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.patchSystemPermission.Input.Path = .init(
                    permissionKey: try converter.getPathParameterAsURI(
                        in: metadata.pathParameters,
                        name: "permissionKey",
                        as: Components.Parameters.SystemPermissionKey.self
                ...
                let headers: Operations.patchSystemPermission.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func updateSystemPermission(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.updateSystemPermission.Input.Path = .init(
                    permissionKey: try converter.getPathParameterAsURI(
                        in: metadata.pathParameters,
                        name: "permissionKey",
                        as: Components.Parameters.SystemPermissionKey.self
                ...
                let headers: Operations.updateSystemPermission.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
